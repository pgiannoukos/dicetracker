...
import gr.codelearn.app.repository.AnimalDiceRepository;
...
@Service
@Slf4j
public class AnimalDiceService {

    private AnimalDiceRepository diceRepository;

    public AnimalDiceService() {
        diceRepository = new AnimalDiceRepository();
    }
