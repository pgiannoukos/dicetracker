...
import gr.codelearn.app.repository.ShapeDiceRepository;
...
@Service
@Slf4j
public class ShapeDiceService {

    private ShapeDiceRepository diceRepository;

    public ShapeDiceService() {
        diceRepository = new ShapeDiceRepository();
    }
